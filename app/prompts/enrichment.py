...
ENRICHMENT_SCHEMAS = {
    ...
    "external_doc": {
        ...
        "prompt": (
            "Этот PDF — внешний документ (спецификация, регламент, правила, справочник), "
            ...
            "- Структура и порядок элементов — строго 1:1 с PDF. Ничего не переставляй, не сокращай, "
            ...
            "1. Каждая таблица из PDF = РОВНО одна <table> в выдаче. НЕ дроби одну таблицу на несколько, "
            ...
            "6. Порядок колонок и строк — строго как в PDF.\n\n"
            "Верни:\n"
